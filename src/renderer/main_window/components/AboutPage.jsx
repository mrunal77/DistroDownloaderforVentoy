      ...
      <div style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 12, padding: 24, display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', paddingTop: 16, display: 'flex', flexDirection: 'column', gap: 8 }}>
          <div style={{ fontSize: 13, color: '#9aa7bd' }}>
            ...
            <a href="https://github.com/mrunal77/DistroDownloaderforVentoy" target="_blank" rel="noopener noreferrer" style={{ color: '#60a5fa', textDecoration: 'none' }}>
              github.com/mrunal77/DistroDownloaderforVentoy
            </a>
          </div>
          <div style={{ fontSize: 13, color: '#9aa7bd' }}>
            <span style={{ color: '#64748b' }}>Report issues:</span>{' '}
            <a href="https://github.com/mrunal77/DistroDownloaderforVentoy/issues" target="_blank" rel="noopener noreferrer" style={{ color: '#60a5fa', textDecoration: 'none' }}>
              GitHub Issues
            </a>
          </div>
        </div>
